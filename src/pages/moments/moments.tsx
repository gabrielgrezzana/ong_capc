...
interface IFotosPorAno {
	[ano: string]: { id: number; image: string; alt: string }[];
}
...
const fotosPorAno: IFotosPorAno = {
	...
	2025: [
		{ id: 53, image: 'https://i.imgur.com/oySvCFW.png', alt: 'Momento CAPC 2025' },
		{ id: 54, image: 'https://i.imgur.com/LsCNvPs.png', alt: 'Momento CAPC 2025' },
		{ id: 55, image: 'https://i.imgur.com/5WkjL2W.png', alt: 'Momento CAPC 2025' },
		{ id: 56, image: 'https://i.imgur.com/2dzNLT7.png', alt: 'Momento CAPC 2025' },
		{ id: 57, image: 'https://i.imgur.com/i7zrNVX.png', alt: 'Momento CAPC 2025' },
		{ id: 58, image: 'https://i.imgur.com/i26hlzF.png', alt: 'Momento CAPC 2025' },
		{ id: 59, image: 'https://i.imgur.com/H1LVL4a.png', alt: 'Momento CAPC 2025' },
		{ id: 60, image: 'https://i.imgur.com/9sHMkiA.png', alt: 'Momento CAPC 2025' },
		{ id: 61, image: 'https://i.imgur.com/DNWztg2.png', alt: 'Momento CAPC 2025' },
		{ id: 62, image: 'https://i.imgur.com/CW8FhLH.png', alt: 'Momento CAPC 2025' },
		{ id: 63, image: 'https://i.imgur.com/tHp5WNv.png', alt: 'Momento CAPC 2025' },
		{ id: 64, image: 'https://i.imgur.com/wK7VTAG.png', alt: 'Momento CAPC 2025' },
		{ id: 65, image: 'https://i.imgur.com/w7EZ4qY.png', alt: 'Momento CAPC 2025' },
		{ id: 66, image: 'https://i.imgur.com/rOUjl8J.png', alt: 'Momento CAPC 2025' },
		{ id: 67, image: 'https://i.imgur.com/HXa4WUy.png', alt: 'Momento CAPC 2025' },
		{ id: 68, image: 'https://i.imgur.com/eHaukz4.png', alt: 'Momento CAPC 2025' },
		{ id: 69, image: 'https://i.imgur.com/1FZSe9a.png', alt: 'Momento CAPC 2025' },
		{ id: 70, image: 'https://i.imgur.com/P1fr1PY.png', alt: 'Momento CAPC 2025' },
		{ id: 71, image: 'https://i.imgur.com/zxTuSzx.png', alt: 'Momento CAPC 2025' },
		{ id: 72, image: 'https://i.imgur.com/JYnZCtP.png', alt: 'Momento CAPC 2025' },
		{ id: 73, image: 'https://i.imgur.com/BeHEkGH.png', alt: 'Momento CAPC 2025' },
		{ id: 74, image: 'https://i.imgur.com/n39Q4RA.png', alt: 'Momento CAPC 2025' },
		{ id: 75, image: 'https://i.imgur.com/y6oLkdo.png', alt: 'Momento CAPC 2025' },
		{ id: 76, image: 'https://i.imgur.com/RZM7aMv.png', alt: 'Momento CAPC 2025' },
		{ id: 77, image: 'https://i.imgur.com/uorES5h.png', alt: 'Momento CAPC 2025' },
		{ id: 78, image: 'https://i.imgur.com/NgaPPBr.png', alt: 'Momento CAPC 2025' },
		{ id: 79, image: 'https://i.imgur.com/RJ68zT9.png', alt: 'Momento CAPC 2025' },
		{ id: 80, image: 'https://i.imgur.com/U3hLWoK.png', alt: 'Momento CAPC 2025' },
		{ id: 81, image: 'https://i.imgur.com/4cag4LG.png', alt: 'Momento CAPC 2025' },
		{ id: 82, image: 'https://i.imgur.com/3uVhUGs.png', alt: 'Momento CAPC 2025' },
		{ id: 83, image: 'https://i.imgur.com/2KW71fD.png', alt: 'Momento CAPC 2025' },
		{ id: 84, image: 'https://i.imgur.com/4DPNGtB.png', alt: 'Momento CAPC 2025' },
	],
	'2025 páscoa': [
		{ id: 85, image: 'https://i.imgur.com/W8z4pVR.png', alt: 'Momento CAPC 2025' },
		{ id: 86, image: 'https://i.imgur.com/74q7CVs.png', alt: 'Momento CAPC 2025' },
		{ id: 87, image: 'https://i.imgur.com/CgtNUhh.png', alt: 'Momento CAPC 2025' },
		{ id: 88, image: 'https://i.imgur.com/hErFVpE.png', alt: 'Momento CAPC 2025' },
	],
};

const anos = [2014, 2015, 2016, 2017, 2018, 2019, 2025, '2025 páscoa'];

const Moments = () => {
	const [anoSelecionado, setAnoSelecionado] = useState<string | number>(2025); // O ano mais recente como padrão
	...
	const nextSlide = () => {
		setCurrentIndex((prevIndex) =>
			prevIndex + photosPerPage >= fotosMomentos.length ? 0 : prevIndex + photosPerPage
		);
	};
	...
	const prevSlide = () => {
		setCurrentIndex((prevIndex) =>
			prevIndex - photosPerPage < 0
				? fotosMomentos.length - (fotosMomentos.length % photosPerPage || photosPerPage)
				: prevIndex - photosPerPage
		);
	};

	const handleAnoChange = (ano: string | number) => {
		setAnoSelecionado(ano);
		setCurrentIndex(0); // Resetar para a primeira página ao mudar o ano
	};

	const visiblePhotos = fotosMomentos.slice(currentIndex, currentIndex + photosPerPage);
				...
				>
					<select
						...
						style={{
							...
							backgroundImage:
								'url(\'data:image/svg+xml;utf8,<svg fill="%23F77C2C" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>\')',
				...
				{Array.from({
					...
					<button
						...
						style={{
							...
							borderRadius: '50%',
							border: 'none',
							background: currentIndex === index * photosPerPage ? '#F77C2C' : '#ccc',
							cursor: 'pointer',
							transition: 'all 0.3s ease',
						}}
					/>
